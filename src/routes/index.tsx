  ...
  return (
    <section className="py-20 md:py-28">
      <div className="mx-auto max-w-5xl px-5">
        <div className="relative overflow-hidden rounded-[2rem] bg-[var(--gradient-hero)] p-10 md:p-16 text-primary-foreground shadow-[var(--shadow-warm)]">
          <PawPrint className="absolute -right-6 -bottom-6 h-48 w-48 opacity-15" />
          <h2 className="font-display text-4xl md:text-5xl font-bold max-w-2xl leading-tight">
            Faça seu pedido agora pelo WhatsApp.
          </h2>
          <p className="mt-4 text-lg opacity-95 max-w-xl">
            Atendimento rápido e personalizado para tutores e revendedores. Estamos prontos para cuidar do seu pet.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <a href={WHATSAPP} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-background text-foreground px-6 py-3.5 font-semibold hover:bg-secondary transition">
              <MessageCircle className="h-5 w-5" /> Fazer Pedido Agora
            </a>
            <a href={PHONE} className="inline-flex items-center gap-2 rounded-full border-2 border-primary-foreground/40 px-6 py-3.5 font-semibold hover:bg-primary-foreground/10 transition">
